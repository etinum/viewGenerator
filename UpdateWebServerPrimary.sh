...
ncftpput.exe -R -v -u "prant_1\ertran_adm" -p "5aeJi4gc7qFJ@e^" NHOVWEBPLS001 . /cygdrive/c/Developer/IIS/RepoFormsApp/ 
ncftpput.exe -R -v -u "prant_1\ertran_adm" -p "5aeJi4gc7qFJ@e^" NHOVWEBPLS001 . /cygdrive/c/Developer/IIS/PlsWebApi/ 
echo "primary" >> /home/ertran/Script/iis.history
